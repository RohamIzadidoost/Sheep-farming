...
func (s *TreatmentService) Create(ctx context.Context, userID, sheepID uint, t domain.Treatment) error {
	return s.repo.AddTreatment(ctx, userID, sheepID, t)
}

func (s *TreatmentService) List(ctx context.Context, userID uint, from, to *time.Time) ([]domain.Treatment, error) {
	return s.repo.FilterTreatments(ctx, userID, from, to)
}

func (s *TreatmentService) Update(ctx context.Context, userID, sheepID uint, index int, t domain.Treatment) error {
	return s.repo.UpdateTreatment(ctx, userID, sheepID, index, t)
}

func (s *TreatmentService) Delete(ctx context.Context, userID, sheepID uint, index int) error {
