...
func (s *VaccineService) CreateVaccine(ctx context.Context, vaccine *domain.Vaccine) error {
	vaccine.ID = "" // ID will be generated by the repository
	vaccine.CreatedAt = time.Now()
	vaccine.UpdatedAt = time.Now()
	return s.repo.CreateVaccine(ctx, vaccine)
}

// GetVaccineByID retrieves a vaccine definition by its ID.
func (s *VaccineService) GetVaccineByID(ctx context.Context, userID, vaccineID string) (*domain.Vaccine, error) {
	return s.repo.GetVaccineByID(ctx, userID, vaccineID)
}

// GetAllVaccines retrieves all vaccine definitions for a given user.
func (s *VaccineService) GetAllVaccines(ctx context.Context, userID string) ([]domain.Vaccine, error) {
...
func (s *VaccineService) DeleteVaccine(ctx context.Context, userID, vaccineID string) error {
